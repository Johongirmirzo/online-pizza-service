const BASE_URL = "http://localhost:8800/api/v1.0";
...
const ENDPOINTS = {
    ...
    GET_ALL_EMPLOYEE_EMERGENCY_CONTACTS: "/employee/get-all-employee-emergency-contacts",
    GET_EMPLOYEE_EMERGENCY_CONTACT: "/employee/get-employee-emergency-contact",
    CREATE_EMPLOYEE_EMERGENCY_CONTACT: "/employee/create-employee-emergency-contact",
    EDIT_EMPLOYEE_EMERGENCY_CONTACT: "/employee/edit-employee-emergency-contact",
    DELETE_EMPLOYEE_EMERGENCY_CONTACT: "/employee/delete-employee-emergency-contact",
