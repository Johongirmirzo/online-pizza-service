<template>
  <section class="applicants">
    <header class="applicants__header">
      <h1 class="applicants__title">All Applicants</h1>
    </header>
    <DeleteModal
...
const downloadCSVFilename = "all-applicants.csv";
...
const handleDownloadExcelClick = () => {
  generateExcel(applicantsPdfTable.value, "applicants", "applicants");
};
const handleDownloadPdfClick = () => {
  generatePDF("applicants-table", applicantsPdfTable.value);
};
...
const fetchAllApplicants = async () => {
  ...
  applicants.value = [...applicantsResp.data.data];
