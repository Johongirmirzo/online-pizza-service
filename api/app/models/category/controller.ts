...
const CategoryController = {
    ...
    async createCategory(req: Request, res: Response){
      const {newCategory, statusCode, error} = await CategoryService.createCategory(req.body, req.file);
    ...
    async editCategory(req: Request, res: Response){
      const id = Number(req.params.id);
      const {statusCode, error} = await CategoryService.editCategory(id, req.body, req.file);
