...
router.get("/get-all-messages", verifyUser, isAllowedToAccess, MessageController.getAllMessages)
router.get("/get-message/:id", verifyUser, isAllowedToAccess, validateReqParamForId, MessageController.getMessage)
router.delete("/delete-message/:id", verifyUser, isUserAdmin, validateReqParamForId, MessageController.deleteMessage)
