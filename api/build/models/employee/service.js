...
const EmployeeService = {
            ...
            try {
                ...
                if (!employee) {
                    ...
                    if (employeeWithGivenData) {
                        if (employee.id !== employeeWithGivenData.id && ((employeeData === null || employeeData === void 0 ? void 0 : employeeData.email) === employeeWithGivenData.email ||
                    ...
                    const employeeParsedData = {
                        birthDate: (employeeData === null || employeeData === void 0 ? void 0 : employeeData.birthDate) ? new Date(employeeData === null || employeeData === void 0 ? void 0 : employeeData.birthDate) : employee.birthDate,
                        salary: (employeeData === null || employeeData === void 0 ? void 0 : employeeData.salary) ? Number(employeeData === null || employeeData === void 0 ? void 0 : employeeData.salary) : employee.salary,
                        emergancyContacts: (employeeData === null || employeeData === void 0 ? void 0 : employeeData.emergancyContacts) ? JSON.parse(employeeData === null || employeeData === void 0 ? void 0 : employeeData.emergancyContacts) : employee.emergancyContacts
                    };
                ...
                if (!employee) {
                    ...
                    if (employee.emergancyContacts.length > 3) {
                        ...
                        const newEmergencyContact = yield prisma_1.prisma.employee.update({
                            where: { id },
                            data: {
                                emergancyContacts: [...employee.emergancyContacts, Object.assign(Object.assign({}, emergencyData), { id: (0, uuid_1.v4)(), notes: "", addressLine2: "", created: `${new Date()}`, updated: `${new Date()}` })]
                            }
                        });
    ...
    getAllEmployeeNotes() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield prisma_1.prisma.employee.findMany({ select: { id: true, firstname: true, lastname: true, employeeNotes: true } });
        });
    },
    getEmployeeNote(employeeId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const employee = yield prisma_1.prisma.employee.findUnique({ where: { id: employeeId }, select: { employeeNotes: true } });
            ...
            try {
                ...
                if (!employee) {
                    ...
                    const newEmployeeNote = yield prisma_1.prisma.employee.update({
                        where: { id: employeeId },
                        data: {
                            employeeNotes: [...employee.employeeNotes, Object.assign({ id: (0, uuid_1.v4)() }, employeeNoteData)]
                        }
                    });
    ...
    getAllEmployeeLeaveDays() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield prisma_1.prisma.employee.findMany({ select: { id: true, firstname: true, lastname: true, leaveDays: true } });
        });
    },
    getEmployeeLeaveDay(leaveDayId, employeeId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const employee = yield prisma_1.prisma.employee.findUnique({ where: { id: employeeId }, select: { leaveDays: true } });
                if (!employee) {
    ...
    createEmployeeLeaveDay(employeeId, leaveDayData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const employee = yield prisma_1.prisma.employee.findUnique({ where: { id: employeeId } });
                if (!employee) {
                    return { newEmployeeNote: null, statusCode: 404, error: "Employee has not been found" };
                }
                else {
                    const newEmployeeNote = yield prisma_1.prisma.employee.update({
                        where: { id: employeeId },
                        data: {
                            leaveDays: [...employee.leaveDays, Object.assign(Object.assign({ id: (0, uuid_1.v4)() }, leaveDayData), { status: "NEW" })]
                        }
                    });
